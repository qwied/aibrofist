...
const Q = [
  ...
  ['какие бывают жидкости?',            'liquids'],
  ['сколько можно быть под водой',      'liquids'],
  ['чем лава отличается от кислоты',    'liquids'],
  ['как сделать зыбучий песок',         'liquids'],
  ['что делает ртуть',                  'liquids'],
  ['почему в смоле не двигаюсь',        'liquids'],
