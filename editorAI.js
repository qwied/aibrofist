...
(function () {
  ...
  function drawForm() {
    body.innerHTML =
      ...
      + '</div>'
      + '<div id="genOut"></div>'
      + '<div id="genHint">Понимает: тип (лабиринт, башня, арена, паркур, пещера, город, острова, мост), '
      + 'размер, сложность, режим, шипы, батуты, движущиеся и вращающиеся блоки, кнопки, '
      + 'число монет и укрытий, размер вида 40x16. Карта заменяет текущую — Ctrl+Z вернёт обратно.</div>';
