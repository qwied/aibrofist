...
(function () {
  ...
  var D = {
    ...
    modeFree:     ['Светлая и тёмная тема доступны всем и включаются сразу.','Light and dark are free for everyone and apply instantly.','Світла і темна тема доступні всім і вмикаються одразу.','Hell und Dunkel sind für alle frei und gelten sofort.','Clair et sombre sont gratuits et s\'appliquent aussitôt.','Claro y oscuro son gratis y se aplican al instante.','Claro e escuro são grátis e aplicam-se de imediato.','Jasny i ciemny są darmowe i działają od razu.','Açık ve koyu herkese ücretsiz, anında uygulanır.','浅色与深色对所有人免费，立即生效。'],
