...
(function () {
  ...
  var D = {
    ...
    roulSpin:     ['Кому водить в этом раунде?','Who is seeking this round?','Кому шукати в цьому раунді?','Wer sucht diese Runde?','Qui cherche cette manche ?','¿Quién busca esta ronda?','Quem procura nesta ronda?','Kto szuka w tej rundzie?','Bu turda kim arayacak?','这一回合谁来找？'],
    roulYouSeek:  ['Ты — искатель! Ищи всех','You are the seeker! Go find them','Ти — шукач! Шукай усіх','Du bist der Sucher! Finde alle','Tu es le chercheur ! Trouve-les','¡Eres el buscador! Búscalos a todos','És o procurador! Procura-os','Jesteś szukającym! Znajdź ich','Aranayan sensin! Hepsini bul','你是寻找者！去找他们吧'],
