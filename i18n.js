...
(function () {
  ...
  var D = {
    ...
    skinSub:      ['Рисуй свой скин прямо по фигуре. Готовую работу можно выложить в Skins Browser.','Draw your own skin right on the figure. Publish your work to the Skins Browser.','Малюй свій скін прямо по фігурі. Готову роботу можна викласти в Skins Browser.','Zeichne deinen Skin direkt auf die Figur. Veröffentliche dein Werk im Skins Browser.','Dessine ton skin directement sur le personnage. Publie ton œuvre dans le Skins Browser.','Dibuja tu skin directamente sobre la figura. Publica tu obra en el Skins Browser.','Desenha o teu skin diretamente na figura. Publica o teu trabalho no Skins Browser.','Rysuj własny skin bezpośrednio na figurze. Gotową pracę opublikuj w Skins Browser.','Cildini doğrudan figure çiz. Hazır işini Skins Browser\'da yayınla.','直接在人物上绘制你的皮肤，并把作品发布到皮肤库。'],
    skinsSub:     ['Скины игроков. Оценивайте чужие работы.','Player skins. Rate other people\'s work.','Скіни гравців. Оцінюйте чужі роботи.','Spieler-Skins. Bewerte die Arbeit anderer.','Skins des joueurs. Notez le travail des autres.','Skins de jugadores. Valora el trabajo de otros.','Skins de jogadores. Avalie o trabalho de outros.','Skiny graczy. Oceniaj prace innych.','Oyuncu görünümleri. Başkalarının işini oyla.','玩家皮肤。为他人作品评分。'],
