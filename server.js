...
const PRIVATE = ['/server.js','/accounts.js','/maps.js','/skins.js','/userskins.js','/lang.js','/extras.js','/package.json','/package-lock.json','/readme-v26.md','/audit-ui.js','/test-ui.js','/check-domain.js','/domain-pp-ua.md'];
app.use((req, res, next) => {
